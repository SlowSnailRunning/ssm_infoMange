...
<body>
	...
	<div id="wrapper">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="index.html">用户信息管理系统</a>
		</div>
		<!-- /.navbar-header -->
		...
		<div id="page-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-body">
					<form class="form-inline" action="${pageContext.request.contextPath }/search/lists.action" method="post">
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="col-md-12 text-right">
							<itcast:page url="${pageContext.request.contextPath }/search/lists.action" />
						</div>
						<!-- /.panel-body -->
					</div>
					<!-- /.panel -->
	...
	<script type="text/javascript">
		function editCustomer(id) {
			$.ajax({
				type:"get",
				url:"<%=basePath%>search/detail.action",
				data:{"id":id},
		...
		function updateCustomer() {
			$.post("<%=basePath%>search/updateCustomer.action",$("#edit_customer_form").serialize(),
				function(data){
				console.log(data);
				alert("客户信息更新成功！<%=basePath%>");
		...
		function deleteCustomer(id) {
			if(confirm('确实要删除该客户吗?')) {
				$.post("<%=basePath%>search/deleteCustomer.action",{"id":id},function(data){
					alert("客户删除更新成功！\n"+data);
					window.location.reload();
				});
			}
